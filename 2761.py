...
class BLEConfigurator:
    ...
    async def run(self):
        ...
        try:
            ...
            await self.send_command("-l 1 2761.bin")
            await self.send_command("actse 13 100")
            ...
            while not self.accel_calibration_complete:
                await asyncio.sleep(1)
            await self.send_command("actse 64 800")
            await self.send_command("actse 72 200")
            print("Rotate the device around all axes.")
